 ...
 * //httpclient/src/java/org/apache/commons/httpclient/HttpParser.java,v 1.13
 * 2005/01/11 13:57:06 oglueck Exp $ $Revision: 533405 $ $Date: 2007-04-28
 * 20:19:29 +0200 (Sat, 28 Apr 2007) $
 *
 * ====================================================================
 *
...
public class HttpParser {
    ...
    public static Header[] parseHeaders(final InputStream is, final String charset) throws IOException, HttpException {
        ...
        for (;;) {
            final String line = HttpParser.readLine(is, charset);
